...
<div class="profile_edit_container">
    ...
    <div class="profile_edit_card">
        ...
        ========================================= --%>
        <form
            action="${pageContext.request.contextPath}/member/profile/edit"
            method="post"
            ...
            <div class="profile_edit_row">
                ...
                <span class="profile_edit_label">
                    이메일
                </span>

                <div class="profile_edit_readonly">
                    ${loginUser.email}
                </div>
