	...
	<div class="my_container">
					...
					<div class="my_challenger_info">
						...
						<div class="my_meta_content">
							<div class="my_meta_row_top">
								...
								<span class="my_badge_blue font-mono">Lv.1000</span> <span
									class="my_streak_badge font-mono"> <span
				...
				<div class="my_stat_grid">
					<div class="my_stat_card">
						...
						<div class="my_stat_value font-mono">
							<span data-stat="dailyCount">0</span><span class="my_stat_unit">편</span>
						</div>
					</div>
					<div class="my_stat_card">
						<span class="my_stat_label">평균 하루 평점</span>
						<div class="my_stat_value rating font-mono">
							<span data-stat="avgTotalRating">0.0</span><span class="my_stat_unit">/5.0</span>
						</div>
					</div>
					<div class="my_stat_card">
						<span class="my_stat_label">총 서브 리뷰</span>
						<div class="my_stat_value sub font-mono">
							<span data-stat="subCount">0</span><span class="my_stat_unit">개</span>
						</div>
					</div>
					<div class="my_stat_card">
						<span class="my_stat_label">내돈내산 인증률</span>
						<div class="my_stat_value verify font-mono">
							<span data-stat="certifiedRate">0</span><span class="my_stat_unit">%</span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="my_bottom_column">
			...
			<div class="my_curation_tab_bar">
				<button type="button" onclick="switchTab('daily')" id="tabBtn-daily"
					class="my_curation_tab active">
					<span class="material-symbols-outlined">calendar_today</span> 내 데일리
					기록
				</button>
						...
						<c:forEach var="rev" items="${myReviews}">
							<div class="my_card">
								<div class="my_card_header">
									<span class="my_card_date font-mono">week</span> <span
										class="my_card_rating font-mono">★ 5.0</span>
								</div>
								<p class="my_card_comment">${rev.summary}</p>
								<div class="my_card_footer">
									<span class="my_card_sub_count">서브 리뷰 n}개</span> <a
										href="${pageContext.request.contextPath}/review/${rev.id}"
										class="my_card_link">상세보기 →</a>
								</div>
							</div>
						</c:forEach>
					</c:otherwise>
